...
<rect width="900" height="182" fill="#193d46"/><text x="42" y="48" class="sans" font-size="16" fill="#fff">9:41</text><text x="852" y="48" text-anchor="end" class="sans" font-size="15" fill="#fff">●  ▰</text>
...
<text x="{x + width - 24}" y="{268 + height - 16}" text-anchor="end" class="sans" font-size="12" fill="#69806f">10:42  ✓✓</text>
