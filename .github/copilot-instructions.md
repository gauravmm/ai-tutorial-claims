...
Do not write a script that parses the source files. Read the files and extract as the user asked.

Do not copy `dataset/claim.reference.csv` into `claim.csv`. Copy it only if the user says they finished stage 1, or they skip to stage 2.
